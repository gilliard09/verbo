...
import { CHECKOUT_FUNDADOR, CHECKOUT_PLUS } from '../constants/checkout';
import {
    ...
    return (
      <div className="min-h-screen bg-[#FAFAFA] pb-12" style={{ fontFamily: "'Poppins', sans-serif" }}>
        ...
        <div className="max-w-md mx-auto px-5 pt-8">
          ...
          <button
            onClick={() => {
              const url = emailUsuario
                ? `${CHECKOUT_PLUS}?email=${encodeURIComponent(emailUsuario)}`
                : CHECKOUT_PLUS;
    ...
    <div className="min-h-screen bg-[#FAFAFA] pb-12" style={{ fontFamily: "'Poppins', sans-serif" }}>
      ...
      <div className="max-w-md mx-auto px-5 pt-8">
        ...
        <div className="flex justify-center gap-5 text-[10px] font-black text-gray-400 uppercase tracking-widest mb-8">
          ...
          <span className="flex items-center gap-1"><CheckCircle2 size={10} /> Cakto</span>
